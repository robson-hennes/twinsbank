...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-accountIncomes">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.income.fields.account') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
...
@endcan
  ...
  let table = $('.datatable-accountIncomes:not(.ajaxTable)').DataTable({ buttons: dtButtons })
