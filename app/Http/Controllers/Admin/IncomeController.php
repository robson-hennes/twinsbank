...
class IncomeController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.incomes.create', compact('income_categories', 'accounts'));
    }
    ...
    public function edit(Income $income)
    {
        ...
        $income->load('income_category', 'account');

        return view('admin.incomes.edit', compact('income_categories', 'accounts', 'income'));
    }
