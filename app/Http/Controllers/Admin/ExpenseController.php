...
class ExpenseController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.expenses.create', compact('expense_categories', 'accounts'));
    }
    ...
    public function edit(Expense $expense)
    {
        ...
        $expense->load('expense_category', 'account');

        return view('admin.expenses.edit', compact('expense_categories', 'accounts', 'expense'));
    }
